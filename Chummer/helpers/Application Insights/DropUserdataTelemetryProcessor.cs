...
namespace Chummer
{
    public class DropUserdataTelemetryProcessor : ITelemetryProcessor
    {
        ...
        {
            ModifyItem(item);
            if (GlobalOptions.Instance.UseLoggingApplicationInsights == UseAILogging.Trace)
            {
                this.Next.Process(item);
                return;
            }
            if (GlobalOptions.Instance.UseLoggingApplicationInsights >= UseAILogging.Crashes)
            {
            ...
            if (GlobalOptions.Instance.UseLoggingApplicationInsights >= UseAILogging.OnlyMetric)
            {
            ...
            if (GlobalOptions.Instance.UseLoggingApplicationInsights >= UseAILogging.Info)
            {
